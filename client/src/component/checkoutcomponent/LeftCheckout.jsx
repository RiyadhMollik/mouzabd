              ...
              <div className="grid grid-cols-3 gap-4 mt-3">
                    ...
                    <div className='flex items-center justify-around'>
                      <div className="flex justify-center mb-2">
                        <div className="w-12 h-12 rounded-lg flex items-center justify-center">
                          <img src="https://freelogopng.com/images/all_img/1656235602bkash-logo-black.png" alt="bKash" />
                        </div>
                      </div>
                      <span className="text-gray-700 font-medium">bKash</span>
                      {formData.paymentMethod === 'bkash' && (
                        <div className="mt-0">
                          <div className="w-5 h-5 bg-pink-500 rounded-full mx-auto flex items-center justify-center">
                ...
                <label className="cursor-pointer">
                  <input
                    ...
                    name="paymentMethod"
                    value="others"
                    checked={formData.paymentMethod === 'others'}
                    onChange={handleInputChange}
                    className="sr-only"
                  />
                  <div className={`
                  ...
                  `}>
                    <div className='flex items-center justify-around'>
                      ...
                      <span className="text-gray-700 font-medium">Rocket or Nagad</span>
                      {formData.paymentMethod === 'others' && (
                        <div className="">
              ...
              {formData.paymentMethod === 'eps' && (
                <div className="mt-4 p-4 bg-green-50 border border-green-200 rounded-lg">
                  <div className="flex items-center space-x-2 mb-2">
                    ...
                    <span className="text-sm font-medium text-green-800">EPS সিকিউর পেমেন্ট</span>
                  </div>
                  <p className="text-xs text-green-700">
                    EPS পেমেন্ট গেটওয়ে ব্যবহার করে আপনি নিরাপদে যেকোনো ব্যাংক একাউন্ট, মোবাইল ব্যাংকিং বা কার্ড দিয়ে পেমেন্ট করতে পারবেন।
                  </p>
                </div>
              )}
            </div>
